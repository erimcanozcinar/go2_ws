#include <legged_controllers/Go2MPC.h>
...
namespace legged
{
  ...
  void Go2MPC::update(const ros::Time &time, const ros::Duration &period)
  {
...
PLUGINLIB_EXPORT_CLASS(legged::Go2MPC, controller_interface::ControllerBase)